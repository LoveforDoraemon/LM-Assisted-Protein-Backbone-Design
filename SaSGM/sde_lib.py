...
class SDE(abc.ABC):
    ...
    def reverse(self, score_fn, probability_flow=False):
        ...
        class RSDE(self.__class__):
            ...
            def sde(self, x, t, context):
                """Create the drift and diffusion functions for the reverse SDE/ODE."""
                drift, diffusion = sde_fn(x, t)
                score = score_fn(x, t, context)  # NOTE
            ...
            def discretize(self, x, t, context):
                """Create discretized iteration rules for the reverse diffusion sampler."""
                f, G = discretize_fn(x, t)  # context only use to calc score
                rev_f = f - G[:, None, None, None] ** 2 * score_fn(x, t, context) * (
                    0.5 if self.probability_flow else 1.0
                )
...
class VESDE(SDE):
    ...
    def sde(self, x, t):
        ...
        drift = torch.zeros_like(x)  # zero tensor just like x
